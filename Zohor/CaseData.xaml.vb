...
Public Class CaseData
    ...
    Public ShowSecondName = False
    Public ShowThirdName = False
    Public ShowForthName = False
    ...
    Private Sub BasicForm2_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Dim v() As String = {MainId, MainId2, MainId3, SubId, SubName, SubName2, SubName3, SubName4, "DayDate"}
        bm.Fields = v

        Dim c() As Control = {CboMain, txtMyKey, txtMyFlag, txtID, txtName, txtName2, txtName3, txtName4, DayDate}
        bm.control = c

        Dim k() As String = {MainId, MainId2, MainId3, SubId}
        bm.KeyFields = k

        If Not ShowSecondName Then
            lbl2.Visibility = Visibility.Hidden
            txtName2.Visibility = Visibility.Hidden
        End If

        If Not ShowThirdName Then
            lbl3.Visibility = Visibility.Hidden
            txtName3.Visibility = Visibility.Hidden
        End If

        If Not ShowForthName Then
