...
Public Class OfficialHolidays
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Dim v() As String = {SubId, SubName, "FromDate", "ToDate"}
        bm.Fields = v
        Dim c() As Control = {txtID, txtName, FromDate, ToDate}
        bm.control = c
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtName.Text.Trim = "" Then
            ...
            Return
        End If
        If FromDate.SelectedDate Is Nothing Or ToDate.SelectedDate Is Nothing Then Return
    ...
    Private Sub LoadResource()
        ...
        lblFromDate.SetResourceReference(ContentProperty, "FromDate")
        lblTodate.SetResourceReference(ContentProperty, "Todate")
    End Sub
