...
Public Class BankCash5
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As Input.KeyEventArgs) Handles txtID.KeyDown, InvestorId.KeyDown, CostCenterId.KeyDown
    ...
    Private Sub InvestorId_KeyDown(ByVal sender As Object, ByVal e As Input.KeyEventArgs) Handles InvestorId.KeyUp
