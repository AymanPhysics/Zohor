...
Public Class DirectBonusCut
    ...
    Private Sub txtID_KeyPress3(ByVal sender As Object, ByVal e As Input.KeyEventArgs) Handles hh.KeyDown, mm.KeyDown
    ...
    Private Sub LoadResource()
        ...
        lblType.SetResourceReference(ContentProperty, "Type")
        Label6.SetResourceReference(ContentProperty, "Duration")
        lblhh.SetResourceReference(ContentProperty, "hh")
        lblmm.SetResourceReference(ContentProperty, "mm")

        bm.ResetComboboxContent(IsVal)
    End Sub
