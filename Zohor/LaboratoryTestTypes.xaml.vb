...
Public Class LaboratoryTestTypes
    ...
    Public TableName As String = "LaboratoryTests"
    ...
    Private Sub LaboratoryTestTypes_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = {MainId, SubId, SubName, "AllTests"}
        bm.control = {CboMain, txtID, txtName, AllTests}
    ...
    Private Sub LoadResource()
        ...
        lblMain.SetResourceReference(ContentProperty, "Test Type")
