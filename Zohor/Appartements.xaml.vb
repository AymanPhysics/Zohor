...
Public Class Appartements
    ...
    Public TableName As String = "Appartements"
    Public MainId As String = "BuildingId"
    ...
    Private Sub BasicForm2_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.FillCombo("Buildings", CboMain, "")

        bm.Fields = {MainId, SubId, "Name", "Discription", "Floor", "Area", "Notes"}
        bm.control = {CboMain, txtID, txtName, Discription, Floor, Area, Notes}
