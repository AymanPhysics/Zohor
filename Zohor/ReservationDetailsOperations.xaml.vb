...
Public Class ReservationDetailsOperations
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        'TabItem01.Visibility = Visibility.Collapsed
        TabItem02.Visibility = Visibility.Collapsed
        TabItem03.Visibility = Visibility.Collapsed
        TabItem04.Visibility = Visibility.Collapsed
        TabItem05.Visibility = Visibility.Collapsed
        TabItem06.Visibility = Visibility.Collapsed
        TabItem07.Visibility = Visibility.Collapsed
        ...
        For i As Integer = 0 To TabControl3.Items.Count - 1
            If TabControl3.Items(i).Visibility = Visibility.Collapsed Then Continue For
    ...
    Private Sub btnReservClickOLD(ByVal sender As Object, ByVal e As RoutedEventArgs)
        btnNew_Click(Nothing, Nothing)
        Dim btn As Button = sender
        lblReservId.Content = btn.Tag.ToString
        lblTime.Content = btn.Content.ToString.Split(vbCrLf)(0)
        Dim dt As DataTable = bm.ExecuteAdapter("select * from ReservationsOperations where OperationsRoomId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        If dt.Rows.Count > 0 Then
            ...
            OperationDetails.Text = dt.Rows(0)("OperationDetails").ToString
        ...
        dt = bm.ExecuteAdapter("select * from ReservationCbo0Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        G0.Rows.Clear()
        ...
        dt = bm.ExecuteAdapter("select * from ReservationCbo1Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        G1.Rows.Clear()
        For i As Integer = 0 To dt.Rows.Count - 1
            G1.Rows.Add()
        ...
        dt = bm.ExecuteAdapter("select * from ReservationCbo2Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        G2.Rows.Clear()
        For i As Integer = 0 To dt.Rows.Count - 1
            G2.Rows.Add()
        ...
        dt = bm.ExecuteAdapter("select * from ReservationCbo3Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        G3.Rows.Clear()
        For i As Integer = 0 To dt.Rows.Count - 1
            G3.Rows.Add()
        ...
        dt = bm.ExecuteAdapter("select * from ReservationRaysOperations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        G4.Rows.Clear()
        For i As Integer = 0 To dt.Rows.Count - 1
            G4.Rows.Add()
        ...
        dt = bm.ExecuteAdapter("select * from ReservationTestsOperations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        G5.Rows.Clear()
        For i As Integer = 0 To dt.Rows.Count - 1
            G5.Rows.Add()
    ...
    Private Sub btnReservClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        Dim MyRoomId As Integer
        Dim MyReservId As Integer
        Dim MyDayDate As DateTime
        dt = bm.ExecuteAdapter("select top 1 * from RoomsData where CaseId='" & CaseId.Text & "' order by DayDate desc")
        If dt.Rows.Count > 0 Then
            MyRoomId = dt.Rows(0)("RoomId").ToString
            MyReservId = dt.Rows(0)("Id").ToString
            MyDayDate = dt.Rows(0)("DayDate")
            Notes.Text = dt.Rows(0)("Notes").ToString
        End If

        dt = bm.ExecuteAdapter("select * from ReservationCbo0Rooms where RoomId='" & MyReservId.ToString & "' and ReservId='" & MyReservId.ToString & "' and IsCurrent=1")
        G0.Rows.Clear()
        For i As Integer = 0 To dt.Rows.Count - 1
            G0.Rows.Add()
            G0.Rows(i).Cells(GC0.Notes).Value = dt.Rows(i)("Notes").ToString
    ...
    Private Sub DatePicker1_SelectedDatesChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.SelectionChangedEventArgs) Handles DatePicker1.SelectedDateChanged, OperationId.SelectionChanged
        LoadReservations()
    End Sub
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnPrint.Click
        ...
        If OperationId.SelectedValue Is Nothing Then OperationId.SelectedIndex = 0
        rpt.paraname = New String() {"@CaseId", "CaseName", "@Flag", "@MainId", "@DayDate", "@Id", "Header"}
        rpt.paravalue = New String() {Val(CaseId.Text), CaseName.Text, 2, Val(OperationId.SelectedValue), bm.ToStrDate(DatePicker1.SelectedDate), lblReservId.Content.ToString, "Patient History"}
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnSave.Click
        ...
        bm.SaveGrid(G0, "ReservationCbo0Operations", New String() {"OperationId", "DayDate", "ReservId"}, New String() {OperationId.SelectedValue.ToString, bm.ToStrDate(DatePicker1.SelectedDate), lblReservId.Content.ToString}, New String() {"Notes"}, New String() {GC0.Notes}, New VariantType() {VariantType.String}, New String() {GC0.Notes})

        bm.SaveGrid(G1, "ReservationCbo1Operations", New String() {"OperationId", "DayDate", "ReservId"}, New String() {OperationId.SelectedValue.ToString, bm.ToStrDate(DatePicker1.SelectedDate), lblReservId.Content.ToString}, New String() {"Notes"}, New String() {GC1.Notes}, New VariantType() {VariantType.String}, New String() {GC1.Notes})

        bm.SaveGrid(G2, "ReservationCbo2Operations", New String() {"OperationId", "DayDate", "ReservId"}, New String() {OperationId.SelectedValue.ToString, bm.ToStrDate(DatePicker1.SelectedDate), lblReservId.Content.ToString}, New String() {"Notes"}, New String() {GC2.Notes}, New VariantType() {VariantType.String}, New String() {GC2.Notes})

        bm.SaveGrid(G3, "ReservationCbo3Operations", New String() {"OperationId", "DayDate", "ReservId"}, New String() {OperationId.SelectedValue.ToString, bm.ToStrDate(DatePicker1.SelectedDate), lblReservId.Content.ToString}, New String() {"Notes1", "Notes2"}, New String() {GC3.Notes1, GC3.Notes2}, New VariantType() {VariantType.String, VariantType.String}, New String() {GC3.Notes1})

        bm.SaveGrid(G4, "ReservationRaysOperations", New String() {"OperationId", "DayDate", "ReservId"}, New String() {OperationId.SelectedValue.ToString, bm.ToStrDate(DatePicker1.SelectedDate), lblReservId.Content.ToString}, New String() {"Notes"}, New String() {GC4.Notes}, New VariantType() {VariantType.String}, New String() {GC4.Notes})

        bm.SaveGrid(G5, "ReservationTestsOperations", New String() {"OperationId", "DayDate", "ReservId"}, New String() {OperationId.SelectedValue.ToString, bm.ToStrDate(DatePicker1.SelectedDate), lblReservId.Content.ToString}, New String() {"Notes1", "Notes2"}, New String() {GC5.Notes1, GC5.Notes2}, New VariantType() {VariantType.String, VariantType.String}, New String() {GC5.Notes1})
    ...
    Function Delete() As Boolean
        If OperationId.SelectedIndex < 1 OrElse DatePicker1.SelectedDate Is Nothing OrElse lblReservId.Content.ToString = "" Then
            Return False
        End If

        Post(0)
        bm.ExecuteNonQuery("Delete ReservationCbo0Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        bm.ExecuteNonQuery("Delete ReservationCbo1Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        bm.ExecuteNonQuery("Delete ReservationCbo2Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        bm.ExecuteNonQuery("Delete ReservationCbo3Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        bm.ExecuteNonQuery("Delete ReservationRaysOperations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        bm.ExecuteNonQuery("Delete ReservationTestsOperations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
        Return True
    End Function
    ...
    Function Valid() As Boolean
        ...
        If OperationType.SelectedIndex < 1 Then
            bm.ShowMSG("Please, Select an Operation Type")
            OperationType.Focus()
            Return False
        End If
    ...
    Sub LoadReservations()
        Try
            WR.Children.Clear()
            btnNew_Click(Nothing, Nothing)
            If OperationId.SelectedIndex < 1 Then Return

            Dim dt As DataTable = bm.ExecuteAdapter("LoadReservationsOperations", New String() {"OperationsRoomId", "Daydate"}, New String() {Val(OperationId.SelectedValue.ToString), bm.ToStrDate(DatePicker1.SelectedDate)})
    ...
    Private Sub Post(ByVal pp As Integer)
        ...
        bm.ExecuteNonQuery("update ReservationsOperations set Posted=" & pp & ",Notes='" & Notes.Text.Replace("'", "''") & "',Utras='" & Utras.Text.Replace("'", "''") & "',Cervix='" & Cervix.Text.Replace("'", "''") & "',Ovaries='" & Ovaries.Text.Replace("'", "''") & "',Valva='" & Valva.Text.Replace("'", "''") & "',Vagina='" & Vagina.Text.Replace("'", "''") & "',E2='" & E2.Text.Replace("'", "''") & "',HMG='" & HMG.Text.Replace("'", "''") & "',FSH='" & FSH.Text.Replace("'", "''") & "',Against='" & Against.Text.Replace("'", "''") & "',Antagonist='" & Antagonist.Text.Replace("'", "''") & "',RT='" & RT.Text.Replace("'", "''") & "',LT='" & LT.Text.Replace("'", "''") & "',EEnd='" & EEnd.Text.Replace("'", "''") & "',RRemarks='" & RRemarks.Text.Replace("'", "''") & "',PB='" & PB.Text.Replace("'", "''") & "',Remarks1='" & Remarks1.Text.Replace("'", "''") & "',Remarks2='" & Remarks2.Text.Replace("'", "''") & "',Investigations='" & Investigations.Text.Replace("'", "''") & "',NextVisitDate='" & bm.ToStrDate(NextVisitDate.SelectedDate) & "',OperationDetails='" & OperationDetails.Text.Replace("'", "''") & "',PostOperativeDiagnosis='" & PostOperativeDiagnosis.Text.Replace("'", "''") & "',PathologySpecimen='" & PathologySpecimen.Text.Replace("'", "''") & "',ClinicalData='" & ClinicalData.Text.Replace("'", "''") & "',Recomendation='" & Recomendation.Text.Replace("'", "''") & "',SurgeonId='" & SurgeonId.Text.Replace("'", "''") & "',AssistantSurgeonId='" & AssistantSurgeonId.Text.Replace("'", "''") & "',AnesthetistId='" & AnesthetistId.Text.Replace("'", "''") & "',ScrubNurseId='" & ScrubNurseId.Text.Replace("'", "''") & "' where OperationsRoomId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "'")
    ...
    Private Sub t_Tick(ByVal sender As Object, ByVal e As EventArgs)
        ...
        TabControl3.SelectedIndex = 0
        bm.FillCombo("select Id,Name from OperationsRooms union select 0 Id,'-' Name order by Name", OperationId)
        Dim dt As New DataTable
        If OperationId.SelectedIndex > 0 Then
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnDownload.Click
        Try
            ...
            F1 = OperationId.SelectedValue.ToString
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            myCommand = New SqlClient.SqlCommand("select Image from CaseAttachments2Operations where OperationId='" & F1 & "' and DayDate='" & F12 & "' and ReservId='" & F13 & "' and AttachedName='" & F2 & "'" & bm.AppendWhere, con)
        ...
        Try
            If CType(TreeView1.SelectedItem, TreeViewItem).FontSize = 18 Then
                If bm.ShowDeleteMSG("MsgDeleteFile") Then
                    bm.ExecuteNonQuery("delete from CaseAttachments2Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "' and AttachedName='" & TreeView1.SelectedItem.Header & "'" & bm.AppendWhere)
                    LoadTree()
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub LoadTree()
        Dim dt As DataTable = bm.ExecuteAdapter("select AttachedName from CaseAttachments2Operations where OperationId='" & OperationId.SelectedValue.ToString & "' and DayDate='" & bm.ToStrDate(DatePicker1.SelectedDate) & "' and ReservId='" & lblReservId.Content.ToString & "' " & bm.AppendWhere)
        TreeView1.Items.Clear()
        For i As Integer = 0 To dt.Rows.Count - 1
    ...
    Private Sub Button1_Click(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnAttach.Click
        ...
        If o.ShowDialog = Forms.DialogResult.OK Then
            For i As Integer = 0 To o.FileNames.Length - 1
                bm.SaveFile("CaseAttachments2Operations", "OperationId", OperationId.SelectedValue.ToString, "DayDate", bm.ToStrDate(DatePicker1.SelectedDate), "ReservId", lblReservId.Content.ToString, "AttachedName", (o.FileNames(i).Split("\"))(o.FileNames(i).Split("\").Length - 1), "Image", o.FileNames(i))
            Next
        End If
        LoadTree()
    End Sub
    ...
    Private Sub AssistantSurgeonId_KeyDown(ByVal sender As Object, ByVal e As Input.KeyEventArgs) Handles AssistantSurgeonId.KeyUp
    ...
    Private Sub ScrubNurseId_KeyDown(ByVal sender As Object, ByVal e As Input.KeyEventArgs) Handles ScrubNurseId.KeyUp
    ...
    Private Sub CaseId_TextChanged(sender As Object, e As TextChangedEventArgs) Handles CaseId.TextChanged
        ...
        bm.Table_Name = "ReservationsOperations"
        bm.SearchTable(New String() {"OperationsRoomId", "CaseId", "ReservId"}, New String() {OperationId.SelectedValue.ToString, CaseId.Text, lblReservId.Content.ToString}, cboSearch, "dbo.ToStrDate(DayDate)+' - '+cast(ReservId as varchar(100))", New Control() {CaseId}, "order by Name")
    End Sub
