...
Public Class BankCash2
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        LoadResource()
        bm.Fields = New String() {"BankId", SubId, SubId2, "DayDate", "Value", "OutComeTypeId", "Notes", "Canceled", "CostCenterId", "CurrencyId"}
        bm.control = New Control() {BankId, txtFlag, txtID, DayDate, Value, OutComeTypeId, Notes, Canceled, CostCenterId, CurrencyId}
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Val(OutComeTypeId.Text) = 0 Then
            ...
            Return
        End If
        If CostCenterId.Visibility = Visibility.Visible AndAlso Val(CostCenterId.Text) = 0 Then
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As Input.KeyEventArgs) Handles txtID.KeyDown, OutComeTypeId.KeyDown, CostCenterId.KeyDown
