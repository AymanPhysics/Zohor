...
Public Class InFertility3
    ...
    Private Sub InFertility_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        Dim dt As DataTable = bm.ExecuteAdapter("select * from CaseInFertility2 where CaseId=" & MyCase)
        G.Rows.Clear()
    ...
    Private Sub LoadWFH()
        ...
        G.Columns(GC.against).Visible = False
        G.Columns(GC.antagainst).Visible = False
    End Sub
